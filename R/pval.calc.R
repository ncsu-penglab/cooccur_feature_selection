# Calculation of co-occurrence p-values
#
# caluclate the probability that the two species would co-occur at a frequency less than and
# greater than the observed number of co-occurrence sites
#
# @param x row of freq.df 
# @param mtx binary gene expression matrix
# 
# @ return p-values

pvalue.calc <- function(
x,
mtx
){
