# Calculation of co-occurrence correlation 
#
# Record the observed occurrences and co-occurrences of seeds and genes
# Measure the correlation between markers and genes using the hypergeometric distribution
#
